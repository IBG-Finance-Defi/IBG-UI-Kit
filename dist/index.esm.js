...
var Icon$q = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("image", { width: "20", height: "20", href: isDark ? "/images/DarkLogo.png" : "/images/RedLogo.png" })));
};
...
var Icon$I = function (props) {
    return (React.createElement(Svg, { width: "85", height: "140", viewBox: "0 0 85 140", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("g", { filter: "url(#filter0_d)" },
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M60.5002 0L36 61.593H55.075L81 0H60.5002Z", fill: "#A1D2FF" }),
            React.createElement("mask", { id: "mask0", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "11", y: "57", width: "66", height: "75" },
                React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M11.3122 57.7729H76.6696V131.083H11.3122V57.7729Z", fill: "white" })),
            React.createElement("g", { mask: "url(#mask0)" },
                React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M31.291 68.513V63.1509C31.291 62.2792 32.0033 61.569 32.8787 61.569H55.1031C55.9784 61.569 56.6908 62.2792 56.6908 63.1509V68.513C52.7867 66.8706 48.4951 65.9625 43.9909 65.9625C39.4867 65.9625 35.1951 66.8706 31.291 68.513ZM60.5011 70.4176V63.1509C60.5011 60.1854 58.0794 57.7729 55.1031 57.7729H32.8787C29.9024 57.7729 27.4811 60.1854 27.4811 63.1509V70.4176C17.8075 76.0711 11.3122 86.5413 11.3122 98.5227C11.3122 116.505 25.9426 131.083 43.9909 131.083C62.0388 131.083 76.6696 116.505 76.6696 98.5227C76.6696 86.5413 70.1747 76.0711 60.5011 70.4176Z", fill: "url(#paint0_linear)" })),
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M43.9996 125.173C29.1115 125.173 17 113.363 17 98.8472C17 84.3301 29.1115 72.5208 43.9996 72.5208C58.8877 72.5208 71 84.3301 71 98.8472C71 113.363 58.8877 125.173 43.9996 125.173Z", fill: "url(#paint1_linear)" }),
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M52.5415 106.039C52.6467 107.525 51.1495 108.6 49.7753 108.026L44.4431 105.798L39.0905 107.977C37.7112 108.539 36.2239 107.45 36.3426 105.965L36.806 100.171L33.0742 95.7149C32.1204 94.5761 32.6971 92.8318 34.1417 92.4858L39.7743 91.1369L42.828 86.2156C43.6144 84.9481 45.4616 84.9565 46.2364 86.2312L49.2452 91.1807L54.8652 92.5809C56.3066 92.94 56.8673 94.6896 55.9032 95.8197L52.1309 100.241L52.5415 106.039Z", fill: "#FFEFB9" }),
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M4 0H26.7694L56 62.5864H34.6168L4 0Z", fill: "#C7E6FF" })),
        React.createElement("defs", null,
            React.createElement("filter", { id: "filter0_d", x: "0", y: "0", width: "85", height: "139.083", filterUnits: "userSpaceOnUse", "color-interpolation-filters": "sRGB" },
            ...
            React.createElement("linearGradient", { id: "paint0_linear", x1: "37.051", y1: "48.3027", x2: "-1.87544", y2: "105.109", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { "stop-color": "#FFDE78" }),
                React.createElement("stop", { offset: "1", "stop-color": "#FFBA3B" })),
            React.createElement("linearGradient", { id: "paint1_linear", x1: "41.3918", y1: "62.7988", x2: "10.1041", y2: "104.919", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { "stop-color": "#FFD06D" }),
                React.createElement("stop", { offset: "1", "stop-color": "#F99912" })))));
};
...
var Icon$18 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "48px", height: "48px" },
            React.createElement("path", { d: "M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z" }),
            React.createElement("path", { fill: "#FFF", d: "M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z" }))));
};

var Icon$19 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "48px", height: "48px" },
            React.createElement("path", { d: "M43.2,33.9c-0.4,2.1-2.1,3.7-4.2,4c-3.3,0.5-8.8,1.1-15,1.1c-6.1,0-11.6-0.6-15-1.1c-2.1-0.3-3.8-1.9-4.2-4C4.4,31.6,4,28.2,4,24c0-4.2,0.4-7.6,0.8-9.9c0.4-2.1,2.1-3.7,4.2-4C12.3,9.6,17.8,9,24,9c6.2,0,11.6,0.6,15,1.1c2.1,0.3,3.8,1.9,4.2,4c0.4,2.3,0.9,5.7,0.9,9.9C44,28.2,43.6,31.6,43.2,33.9z" }),
            React.createElement("path", { fill: "#fff", d: "M20 31L20 17 32 24z" }))));
};
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { isDark: isDark, onClick: handleClick, className: className },
            icon,
        ...
        React.createElement(AccordionContent, { isOpen: isOpen, 
            // isPushed={isPushed}
            maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass, isDark: isDark }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { isDark: isDark, key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href }, item.label))); })));
        }
        return (React.createElement(MenuEntry, { isDark: isDark, key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, null,
            " ",
            React.createElement("img", { src: "/images/IBG.png", width: "42px" }),
            "  ",
    ...
    return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32" }, props),
        ...
        React.createElement("g", { fill: "none", fillRule: "evenodd" },
            ...
            React.createElement("g", { fill: "#FFF", fillRule: "nonzero" },
                React.createElement("path", { fillOpacity: 0.602, d: "M16.498 4v8.87l7.497 3.35z" }),
                React.createElement("path", { d: "M16.498 4L9 16.22l7.498-3.35z" }),
                React.createElement("path", { fillOpacity: 0.602, d: "M16.498 21.968v6.027L24 17.616z" }),
                React.createElement("path", { d: "M16.498 27.995v-6.028L9 17.616z" }),
                React.createElement("path", { fillOpacity: 0.2, d: "M16.498 20.573l7.497-4.353-7.497-3.348z" }),
                React.createElement("path", { fillOpacity: 0.602, d: "M9 16.22l7.498 4.353v-7.701z" }))),
        React.createElement("script", null)));
};
    ...
    var networks = [
        {
            title: "Binance",
            id: "bsc",
            icon: React.createElement(Icon$b, { width: "32px" }),
            connectorId: "injected",
        ...
        },
        {
            title: "Ethereum",
            id: "eth",
            icon: React.createElement(Icon$1f, { width: "32px" }),
            connectorId: "injected",
            url: "https://eth.ibg.finance"
        },
    ];
    return React.createElement(Modal, { title: "Select A Network", onDismiss: onDismiss }, networks.map(function (entry, index) { return (React.createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { bold: true, color: "primary", mr: "16px" }, entry.title),
        entry.icon)); }));
};
...
var useWalletModal = function (login, logout, account, selectedChain) {
    ...
    var onPresentChainToggleModal = useModal(React.createElement(ChainModal, null))[0];
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "primary", onClick: function () {
        ...
        } }, accountEllipsis)) : (React.createElement(Button, { size: "sm", variant: isDark ? "primary" : "primary", onClick: function () {
...
var ChainToggle = function (_a) {
    ...
    return (React.createElement("div", { style: { marginLeft: 10, marginRight: 10 } }, isBinance ? (React.createElement(Icon$b, { height: 40, width: 40, onClick: function () {
            onPresentChainToggleModal();
        } })) : (React.createElement(Icon$1f, { height: 40, width: 40, onClick: function () {
            onPresentChainToggleModal();
        } }))));
};
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(ChainToggle, { account: account, isBinance: isBinance }),
                React.createElement(UserBlock, { account: account, login: login, logout: logout, isDark: isDark }),
